...
MESSAGE_HANDLE_SHORT: bool = True
MESSAGE_PREPROCESSOR_CYCLIC_WARNING: bool = True
MESSAGE_PROCESSOR_CYCLIC_WARNING: bool = True

MESSAGE_PREPROCESSOR_ALLOW_REPLACE: bool = True
MESSAGE_PROCESSOR_ALLOW_REPLACE: bool = True
